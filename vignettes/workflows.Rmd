...
Orderly supports running workflows - these are pre-configured lists of reports which are run in sequence as part of an analysis.
...
This returns a list containing the name and ID of each of the reports run as part of the workflow
```{r}
out
```
